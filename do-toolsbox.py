...
"""
Digital ocean automator

Usage:
  do-toolbox.py [ --debug ] [ --token=TOKEN ] create [ --image=ubuntu-16-04-x64 ] [ --region=ams3 ] [ --ssh=~/.ssh/id_rsa.pub ] [ --size=512mb ] [ --num=1 ]
  do-toolbox.py [ --debug ] [ --token=TOKEN ] list
  do-toolbox.py [ --debug ] [ --token=TOKEN ] power_off ( <name>... | <id>... )
  do-toolbox.py [ --debug ] [ --token=TOKEN ] power_on  ( <name>... | <id>... )
  do-toolbox.py [ --debug ] [ --token=TOKEN ] reboot    ( <name>... | <id>... )
  do-toolbox.py [ --debug ] [ --token=TOKEN ] destroy   ( <name>... | <id>... )
